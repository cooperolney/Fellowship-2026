...
db_full <- readRDS("dynamic_bayes/dynamic_bayes_full.rds")

db_heatmap_plot <- ggplot(db_full, aes(x = time_elapsed, y = lead_diff, fill = win_prob)) +
  geom_tile() +
  scale_fill_gradientn(colors = c("blue", "green", "white", "yellow", "red")) +
  labs(
    x = "Time elapsed (seconds)", 
...
saveRDS(db_heatmap_plot, "db_heatmap_plot.rds")
```
